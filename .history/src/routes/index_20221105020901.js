...
export default function Router() {
  ...
  return useRoutes([
    {
      path: "/",
      // element: loginInfo.accessToken !== undefined ? <LoginForm /> : <Navigate to="/home/dashboard" replace />,
      element: <LoginForm />,
      children: [
    ...
    {
      path: "/home",
      element: loginInfo loginInfo.accessToken ? <MainForm /> : <Navigate to="/login" replace />,
      children: [
