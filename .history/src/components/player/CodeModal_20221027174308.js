  ...
  return (
    <div className="v-center" >
      <div className="flex-column h-center" style={{width: "35%"}}>
        ...
        <Text className="medium-title mt-bit text-center">{props.type != 'admin' ? "Hemos añadido a un nuevo jugador a nuestra base de datos" : "Hemos agregado un nuevo Super Administrador"}</Text>
        ...
        <Text className="medium-title mt-bit text-center">Enviaremos un email al jugador con el código para que pueda acceder</Text>
      </div>
    </div>
  );
};
