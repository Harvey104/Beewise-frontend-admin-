  ...
  return (
    <div className="v-center" >
      <div className="flex-column h-center" style={{width: "35%"}}>
        ...
        <Text className="medium-title mt-bit text-center">{props.type != 'admin' ? "Enviaremos un email al jugador con el código para que pueda acceder" : "Hemos generado un codigo de acceso  "}</Text>
      </div>
    </div>
  );
};
