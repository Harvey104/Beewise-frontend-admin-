...
const ContainerHeight = "calc(100% - 133px)";
    ...
    >
      ...
      >
        <Row style={{height: "100%"}}>
          ...
          <Col span={10}>
              <div style={{paddingLeft: "40px", height: "100%"}}>
                  ...
                  >
                    {(item) => (
                      <List.Item key={item.id}>
                        <List.Item.Meta
                          title={<div className="v-around list-title">{"# " + item.id + "  " + item.name + " "} <TiDeleteOutline  style={{color: "#EB5757", fontSize: "20px"}}/></div>}
                        />
                      </List.Item>
                    )}
                  </VirtualList>
