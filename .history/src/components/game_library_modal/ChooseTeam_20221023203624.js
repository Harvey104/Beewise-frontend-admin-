        ...
        <Row>
          ...
          <Col span={17} className="pv-medium flex-column v-between" style={{display: "flex"}}>
            ...
            <div className="v-around">
              <Button className='bit-button hs' onClick={() => previous(GAME_MODAL_STEP.CHOOSE_PLAYER)} type="primary">Si</Button>
              <Button className='bit-button hs' onClick={() => previous(GAME_MODAL_STEP.CHOOSE_PLAYER)} type="primary">No</Button>
            </div>
          </Col>
        </Row>
      </div>
