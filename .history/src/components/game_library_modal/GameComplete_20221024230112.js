      ...
      <div style={{width: "90%"}}>
        <Row>
          ...
          <Col span={12} className="flex v-end">
            ...
            >
              <QRCode value={code} />
              <Text className="medium-title mt-small center">Escanea el código para acceder a la competencia</Text>
              <Input placeholder="" className='hm mt-small' style={{width: "100%"}}/>
              <Text className="medium-title mt-small center pv-">O puedes compartir este link con tus  jugadores</Text>
            </div>
          </Col>
        </Row>
      </div>
