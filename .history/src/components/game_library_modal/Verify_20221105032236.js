...
const VerifyComponent = (props) => {
  ...
  const setCompetitionName = props.setCompetitionName;
  ...
  return (
    <>
      <div style={{width: "50%"}}>
        ...
        <Input placeholder="Ingrese nombre del juego" className='hm mt-bit' onChange={(e) => {setCompetitionName(e.target.value)}}/>
