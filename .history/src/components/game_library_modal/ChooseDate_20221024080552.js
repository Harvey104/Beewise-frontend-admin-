      ...
      >
        <div style={{
          ...
          <Row  className="pv-bit">
            ...
            <Col span={12} style={{height: "61px",display: "flex", justifyContent: "space-between", alignItems: "center"}}>
              <div>
                <div className='padding-bit back-grey pv-small ph-bit borderS' style={{display: "table", width: ""}}>
              ...
              <RiErrorWarningFill style={{fontSize: "23px", color: "#5E5BC0", lineHeight: "61px"}} />
            </Col>
          </Row>
        </div>
      </div>
