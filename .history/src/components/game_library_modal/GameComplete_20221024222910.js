    ...
    <div className="flex-column v-between h-center" style={{width: "90%"}}>
      ...
      <div style={{width: "90%"}}>
        <Row>
          ...
          <Col span={12}>
            <div className="padding-medium flex-column v-center"
              style={{
            ...
            >
              <QRCode value={code} />
              <Text className="small-title">Escanea el código para acceder a la competencia</Text>
              <Input placeholder="" className='hm' style={{width: "100%"}}/>
            </div>
          </Col>
        </Row>
      </div>
