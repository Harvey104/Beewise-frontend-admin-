...
import { Button , Col, Row, Input, Table, List, Form } from 'antd';
        ...
        <Row>
          <Col span={15}>
            <div className="">
              ...
              <Button className="small-button hm ml-bit" onClick={() => setMode("select")}>Añadir nuevo jugador</Button>
            </div>
          </Col>
          <Col span={9}>
            <Search
          ...
          <Col span={14} style={{height: "100%"}} className="choose-player-table">
            {
              ...
              : 
                (<Form
                  ...
                  layout={formLayout}
                >
                  <Text className="medium-title">Ingresa los datos requeridos para agregar a un nuevo jugador</Text>
                  <Form.Item label="Nombre y Apellido del jugador">
                    <Input placeholder="Ingrese nombre y apellido del jugador" className='hm'/>
                  </Form.Item>
                </Form>)
            }
