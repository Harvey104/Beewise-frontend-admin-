...
const GameCompleteComponent = (props) => {
  ...
  const listData = [
    {
      avatar: (<HiUsers style={{fontSize: "18px"}}/>),
      title: "20 jugadores"
    },
    {
      avatar: (<FaUsers style={{fontSize: "18px"}}/>),
      title: "4 equipos"
    },
    {
      avatar: (<BsFillQuestionCircleFill style={{fontSize: "18px"}}/>),
      title: "15 preguntas"
    },
    {
      avatar: (<MdOutlineEventNote style={{fontSize: "18px"}}/>),
      title: "Resultados Ponderados"
    },
    {
      avatar: (<BiCalendar style={{fontSize: "18px"}}/>),
  ...
  return (
    <div className="flex-column v-between" style={{width: "90%"}}>
      ...
      <div className="v-center" style={{width: "90%"}}>
        <Row>
          <Col span={12}>
            <List
              size="large"
