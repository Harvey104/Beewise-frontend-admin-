      ...
      <div style={{width: "70%"}}>
        <Row>
          ...
          <Col span={17} className="pv-medium flex-column v-between" style={{display: "flex"}}>
            <Text className='large-title color-black'>Es momento  de  asignarlos en equipos</Text>
            <Text className='medium-title'>Así será más fácil reconocerlo cuando veas los resultados</Text></div>
