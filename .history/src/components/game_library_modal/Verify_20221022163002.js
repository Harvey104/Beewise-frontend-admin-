  ...
  return (
    <>
      ...
      <div className='w-100 v-center'>
        <Button className='bit-button hs' onClick={() => {}} type="primary">Volver</Button>
        <Button className='bit-button hs ml-medium' onClick={() => {}} type="primary">Continuar</Button>
      </div>
    </>
  );
};
