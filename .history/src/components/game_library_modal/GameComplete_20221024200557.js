...
const GameCompleteComponent = (props) => {
  ...
  const listData = [
    {
      avatar: (<HiUsers style={{fontSize: "20px"}}/>),
      title: "20 jugadores"
    },
    {
      avatar: (<FaUsers style={{fontSize: "20px"}}/>),
      title: "4 equipos"
    },
    {
      avatar: (<BsFillQuestionCircleFill style={{fontSize: "20px"}}/>),
      title: "15 preguntas"
    },
    {
      avatar: (<MdOutlineEventNote style={{fontSize: "20px"}}/>),
      title: "Resultados Ponderados"
    },
    {
      avatar: (<BiCalendar style={{fontSize: "20px"}}/>),
