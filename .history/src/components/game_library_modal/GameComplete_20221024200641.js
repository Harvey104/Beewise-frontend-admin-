...
const GameCompleteComponent = (props) => {
  ...
  const listData = [
    {
      avatar: (<HiUsers style={{fontSize: "27px", color: ""}}/>),
      title: "20 jugadores"
    },
    {
      avatar: (<FaUsers style={{fontSize: "27px"}}/>),
      title: "4 equipos"
    },
    {
      avatar: (<BsFillQuestionCircleFill style={{fontSize: "27px"}}/>),
      title: "15 preguntas"
    },
    {
      avatar: (<MdOutlineEventNote style={{fontSize: "27px"}}/>),
      title: "Resultados Ponderados"
    },
    {
      avatar: (<BiCalendar style={{fontSize: "27px"}}/>),
