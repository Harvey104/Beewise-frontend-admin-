  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <Row>
            <Col span={12} className="choose-date">
              <dis><Calendar value={value} onChange={(d) => setValue(d)} /></Col></dis>
            <Col span={12} className="choose-date"><Calendar value={value} onChange={(d) => setValue(d)} /></Col>
          </Row>
