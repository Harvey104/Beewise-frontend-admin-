  ...
  return (
    <>
      ...
      >
        ...
        <div className="choose-date v-around h-center" style={{height: "calc(100% - 40px)"}}>
          <Calendar value={value} onChange={(d) => setValue(d)} style={{box-shadow: 8px 3px 22px 10px rgba(150, 150, 150, 0.11);
border-radius: 16px;}} />
