  ...
  return (
    <>
      <div style={{width: "70%"}}>
        <Row>
          <Col span={7}>
            <div className='w-100' style={{background: "#F2F2FF", borderRadius: "10px", height: "100%"}}>
              <div className='game-library-main-header h-center mt-large v-center' style={{background: "#E8E8FF", borderRadius: "10px 10px 0px 0px"}}>
