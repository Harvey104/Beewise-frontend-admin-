...
const MenuComponent = forwardRef(({ open, setOpen }, ref) => {
  ...
  const items = [
    ...
    getItem(
      <Link onClick={() => {setMenuKey(2); navigate('/general/question')}} ><Text style={{color: "#6A67CE", fontSize: "17px", fontWeight: "600"}}>Crear Juego</Text></Link>,
      '2',
  ...
  const items2 = [
    ...
    getItem(
      <Link onClick={() => {setMenuKey(2); navigate('/general/question')}} ></Link>,
      '2',
      <img src='/img/icon/Vector.png' style={{width: "24px"}}/>,
    ),
    getItem(
