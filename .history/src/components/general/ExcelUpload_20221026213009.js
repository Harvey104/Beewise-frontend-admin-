              ...
              (
                <>
                  ...
                  <div className="panel common-border borderL flex-column h-center mt-medium v-around" style={{height: "255px", border: "2px dashed #6A67CE", background: "#6A67CE"}}>
                    <img src="/img/icon/excel.png"/>
                    <div className="v-center h-center" style={{width: "80%"}}>
                      <img src="/img/icon/modal_success.png" style={{width: "50px"}}/>
                      <Text className="small-title center color-w">Tu archivo ha sido subido con éxito, revisa el resumen de las preguntas cargadas.</Text>
                    </div>
                    <Button 
                      className="mt-bit"
                      style={{
