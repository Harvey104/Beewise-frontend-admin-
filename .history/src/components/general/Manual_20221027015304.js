      ...
      <Row className="mt-medium" gutter={16}>
        ...
        >
            ...
            <Form.Item label="Escribe tus respuestas">
              ...
              <Input placeholder="Alternativa incorrecta" className='hm mt-bit' prefix={<img src="/img/icon/failure.png"/>} onChange={((e) => setSecond(e.target.value))}/>
              <Input placeholder="Alternativa incorrecta" className='hm mt-bit' prefix={<img src="/img/icon/failure.png"/>} onChange={((e) => setFirstAnswer(e.target.value))}/>
              <Input placeholder="Alternativa incorrecta" className='hm mt-bit' prefix={<img src="/img/icon/failure.png"/>} onChange={((e) => setFirstAnswer(e.target.value))}/>
            </Form.Item>
