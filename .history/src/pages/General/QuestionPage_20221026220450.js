  ...
  useEffect(() => {
    if (tab === 2) {
      getQuestionList((list) => {
        let question = list.map((item, index) => {console.log(index);
          return {
            key: index,
            ...
            answers: [
              ...
              {
                state: item.secondAnswer,
                title: item.secondAnswerAccuracy
              },
              {
                state: item.thirdAnswer,
                title: item.thirdAnswerAccuracy
              },
              {
                state: item.fourthAnswer,
                title: item.fourthAnswerAccuracy
              }
            ],
