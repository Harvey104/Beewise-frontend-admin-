...
import {editQuestionAction} from '../../components/actions/Questions';
  ...
  const questionTableColumn = [
    ...
    },
    {
      ...
      render: (category, record) => (
        editId === record.id ?
          <Input className='hm' value={category} onChange={(e) => setQuestionTitle(e.target.value)}/>
          :
          category
      )
    },
    {
      ...
      render: (time, record) => (
        editId === record.id ?
          <Input className='hm' value={time} onChange={(e) => setQuestionTitle(e.target.value)}/>
          :
          time
      )
    },
