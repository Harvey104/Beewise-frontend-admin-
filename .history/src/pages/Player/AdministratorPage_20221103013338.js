...
import { addAdminAction, getAdminsAction, removeAdminsAction } from '../../components/actions/Player';
...
export default function AdministratorPage() {
  ...
  const [verifyCode, setVerifiCode] = useState('');const [mountState, setMountState] = useState(0);
    ...
    },
    {
      ...
      render: () => (
        <div className='v-around h-center'>
          <FiEdit style={{color: "#8146ff", fontSize: "20px"}}/>
          <RiGitBranchFill style={{color: "#8146ff", fontSize: "20px"}}/>
          <FaPause style={{color: "#f26e6e", fontSize: "20px"}}/>
        </div>
      )
    },
  ];
