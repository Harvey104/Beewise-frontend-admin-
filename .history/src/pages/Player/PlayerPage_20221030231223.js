...
import { 
  addPlayerAction, getPlayersAction } from '../../components/actions/Player';
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className='v-around h-center'>
          ...
          {
            record.state === 1 ?
              <img src='/img/icon/user-lock.png' onClick={changeState(record.id, 0)} width={20} height={20}/>
              :
              <img src='/img/icon/user-lock.png' onClick={changeState(record.id, 1)} width={20} height={20}/>
          }
        </div>
      )
    },
