...
import { addPlayerAction } from '../../components/actions/Player';
...
export default function PlayerPage() {
  ...
  const addPlayer = () => {
    ...
    addPlayerAction(addData);
    setModalTab(1); handleCancel();
  }
        ...
        >
            <div className='modal-content flex-column v-between h-center' style={{border: "none", height: "100%"}}>
                ...
                {modalTab == 1 ? 
                  ...
                  : 
                  <div className='w-100 v-center mt-large'>
                    <Button className='bit-button hs' onClick={() => {}} type="primary">Finalizar</Button>
                  </div>
                }
            </div>
        </Modal>
