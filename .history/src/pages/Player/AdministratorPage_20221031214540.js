...
import { addAdminAction } from '../../components/actions/Player';
    ...
    <div className='dashboard'>
        ...
        >
            <div className='modal-content flex-column v-between h-center' style={{border: "none", height: "100%"}}>
                <div className='w-100'>
                  {modalTab == 1 ? <InfoModal type="admin" setFirstName={setFirstName} setLastname={setLastname} setEmail={setEmail} setProfileType={setProfileType}/> : <CodeModal type="admin" setVerify={setVerifiCode}/>}
                </div>
                {modalTab == 1 ? 
