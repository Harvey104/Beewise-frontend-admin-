        ...
        >
            ...
            >
                <div className='w-100'>
                  ...
                  {
                    <Text className='medium-title color-black' style={{marginLeft: "66px", fontSize: "18px"}}></Text>
                      modalStep === GAME_MODAL_STEP.CHOOSE_DATE ? "<br/> Nombre Competencia / Código 1-1-1-1-1" : ''
                  }
                </div>
                {
