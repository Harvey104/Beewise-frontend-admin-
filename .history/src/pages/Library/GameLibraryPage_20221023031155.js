  ...
  return (
    <div className='dashboard'>
        ...
        <Modal
            ...
            footer=''
        >
            <div className={`modal-content ${ modalStep === GAME_MODAL_STEP.VERIFY ? "flex-column v-between h-center" : "" }`} style={{border: "none", height: "100%"}}>
                <div className='w-100'>
                  <div className='' style={{width: "40%"}}>
                    <Steps current={GAME_MODAL_STEP.CHOOSE_PLAYER - 1} progressDot={customDot}>
                      <Step />
                      <Step />
                      <Step />
                      <Step />
                ...
                </div>
                {
                  modalStep === GAME_MODAL_STEP.VERIFY ? 
                    <Verify previous={handleCancel} next={setModalStep}/>
                    :
                    modalStep === GAME_MODAL_STEP.CHOOSE_PLAYER ?
                      <ChoosePlayer/>
                      :
                      ''
                }
