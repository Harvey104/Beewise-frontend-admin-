                ...
                <div className='competition-panel mt-small'>
                  <List
                    ...
                    header={
                      <Row>
                        <Col span={6}>
                          <Text style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "16px", color: "#4441A1" }}>Puesto</Text>
                        </Col>
                        <Col span={12}>
                          <Text style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "16px", color: "#4441A1" }}>Equipo</Text>
                        </Col>
                        <Col span={6}>
                          <Text style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", color: "#4441A1" }}>Puntaje</Text>
                        </Col>
                      </Row>
                    }
