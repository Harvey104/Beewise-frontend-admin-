        ...
        <div className='mt-large'>
          ...
          >
              ...
              <Panel header="Jugadores" key="2" 
                  ...
                  style={{width: "37%"}}
              >
                <Text className='small-title' style={{color: "#6A67CE"}}>Revisa el puntaje de los jugadores.</Text>
                <div className='v-between mt-small'>
                  <img src='/img/icon/rank1.png'/>
                  <div className='v-between h-center padding-small'
                   style={{
                    ...
                    <div className='flex-column v-around'>
                      <Text style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: "16px", color: "#6A67CE", }}>Equipo 1</Text>
                      <Text style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: "16px", color: "#FFFFFF", }}>Equipo 1</Text>
                    </div>
                    <Text style={{ fontFamily: 'Poppins', fontWeight: 500, fontSize: "14px", color: "#FFFFFF", }}>1.600 pts</Text>
                  </div>
                </div>
                <div className='v-between mt-small'>
                  <img src='/img/icon/rank1.png'/>
