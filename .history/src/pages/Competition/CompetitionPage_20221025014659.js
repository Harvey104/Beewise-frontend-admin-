                    ...
                    renderItem={item => (
                      <List.Item style={{padding: "none"}}>
                        <Row style={{width: "100%"}}>
                          ...
                          <Col span={12}><Text className="medium-title color-b" style={{color: "#6A67CE"}}>{item.equi}</Text></Col>
                          <Col span={6}><Text className="medium-title color-b" style={{color: "#6A67CE"}}>{item.score}</Text></Col>
                        </Row>
                      </List.Item>
                    )}
                  />
