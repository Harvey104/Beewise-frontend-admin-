          ...
          >
              ...
              >
                ...
                <div className='mt-small'>
                  <div className='padding-small flex=' style={{background: "#FFFAEC", borderRadius: "10px"}}>
                    <Text style={{fontFamily: 'Inter', fontWeight: 600, fontSize: "16px", lineHeight: "17px", color: "#6A67CE"}}>Jugador 1 vs Jugador 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "15px", color: "#6A67CE"}}>Equipo 1 desafío a Equipo 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "15px", color: "#6A67CE"}}>Ganador: Jugador 1</Text>
                  </div>
                </div>
              </Panel>
          </Collapse>
