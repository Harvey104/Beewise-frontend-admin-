          ...
          >
              ...
              >
                ...
                <List
                  ...
                  header={
                    <Row>
                      <Col span={6}><Text className="medium-title" style={{}}>Puesto</Text></Col>
                  ...
                  renderItem={item => (
                    <Row>
                      ...
                      <Col span={12}><Text className="medium-title">{item.equi}</Text></Col>
                      <Col span={6}><Text className="medium-title">{item.score}</Text></Col>
                    </Row>
                  )}
                />
              </Panel>
