              ...
              >
                ...
                <div className='mt-small'>
                  <div className='padding-small' style={{background: "#FFFAEC", borderRadius: "10px"}}>
                    <Text style={{fontFamily: 'Inter', fontWeight: 600, fontSize: "14px", lineHeight: "17px"}}>Jugador 1 vs Jugador 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "12px", lineHeight: "15px"}}>Equipo 1 desafío a Equipo 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "12px", lineHeight: "15px"}}>Ganador: Jugador 1</Text>
                  </div>
                </div>
              </Panel>
          </Collapse>
