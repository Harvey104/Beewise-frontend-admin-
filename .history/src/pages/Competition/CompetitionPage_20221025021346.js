              ...
              >
                ...
                <div className='mt-small'>
                  <div className='padding-small flex-column' style={{background: "#B4B3E7", borderRadius: "10px"}}>
                    <Text style={{fontFamily: 'Inter', fontWeight: 600, fontSize: "16px", lineHeight: "24px", color: "#FFD66B"}}>Jugador 1 vs Jugador 2</Text>
                    <Text className='mt-small' style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "18px", color: "#FFFFFF"}}>Equipo 1 desafío a Equipo 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "18px", color: "#FFFFFF"}}>Ganador: Jugador 1</Text>
                  </div>
                </div>
              </Panel>
          </Collapse>
