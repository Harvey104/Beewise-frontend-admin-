          ...
          >
              ...
              >
                ...
                <List
                  ...
                  header={
                    <Row>
                      <Col><Text className="medium-title">Puesto</Text></Col>
                      <Col><Text className="medium-title">Equipo</Text></Col>
                      <Col><Text className="medium-title">Nombre: Aves nacionales</Text></Col>
                    </Row>
                  }
                  dataSource={listData}
                  renderItem={item => (
