              ...
              >
                ...
                <div className='mt-small'>
                  <div className='padding-small' style={{background: "#FFFAEC", borderRadius: "10px"}}>
                    ...
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "17px"}}>Equipo 1 desafío a Equipo 2</Text>
                    <Text style={{fontFamily: 'Inter', fontWeight: 500, fontSize: "14px", lineHeight: "17px"}}>Ganador: Jugador 1</Text>
                  </div>
                </div>
              </Panel>
          </Collapse>
