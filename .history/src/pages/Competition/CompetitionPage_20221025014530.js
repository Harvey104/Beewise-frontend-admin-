                ...
                <div className='competition-panel mt-small'>
                  <List
                    ...
                    header={
                      <Row>
                        <Col span={6}>
                          <Text style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "12px", color: "#4441A1" }}>Puesto</Text>
                        </Col>
                        <Col span={12}>
                          <Text className="medium-title" style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "12px", color: "#4441A1" }}>Equipo</Text>
                        </Col>
                        <Col span={6}><Text style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: "12px", color: "#4441A1" }}>Puntaje</Text></Col>
                      </Row>
                    }
