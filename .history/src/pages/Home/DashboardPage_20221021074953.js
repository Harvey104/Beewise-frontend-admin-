        ...
        >
            <div className='modal-content' style={{border: "none", height: "100%", display: "block"}}>
              ...
              <div className='mt-medium'>
                <Button className='bit-button hs'>Juegos</Button>
                <Button className='bit-button hs ml-bit' disabled>Competencias</Button>
                <Button className='bit-button hs ml-bit' disabled>Jugadores</Button>
              </div>
              <Search
