  ...
  return (
    <div className='dashboard'>
        ...
        <Modal
            ...
            footer=''
        >
            <div className='modal-content flex-row' style={{border: "none", height: "100%"}}>
              <Text className='header-title color-back'>Búsqueda</Text>
              <Text className='medium-title'>Para visualizar los resultados, busca la competencia, juego o jugador que desees.</Text>
            </div>
        </Modal>
    </div>
  );
