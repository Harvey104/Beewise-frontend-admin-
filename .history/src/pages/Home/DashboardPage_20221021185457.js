        ...
        >
            <div className='modal-content' style={{border: "none", height: "100%", display: "block"}}>
              ...
              <div className='mt-medium'>
                <Button className={`bit-button hm ${modalStep !== 'game' ? 'back' }`} onClick={() => setModalStep('game')}>Juegos</Button>
                <Button className='bit-button hm ml-bit back-grey' onClick={() => setModalStep('skill')}>Competencias</Button>
                <Button className='bit-button hm ml-bit back-grey' onClick={() => setModalStep('player')}>Jugadores</Button>
              </div>
              <Search
