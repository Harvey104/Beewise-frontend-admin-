        ...
        >
            <div className='modal-content' style={{border: "none", height: "100%", display: "block"}}>
              ...
              <div className='mt-medium'>
                ...
                <Button className={`bit-button hm ml-bit ${modalStep !== 'game' ? 'back-grey': '' }`} onClick={() => setModalStep('skill')}>Competencias</Button>
                <Button className={`bit-button hm ml-bit ${modalStep !== 'game' ? 'back-grey': '' }`} onClick={() => setModalStep('player')}>Jugadores</Button>
              </div>
              <Search
